...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 07, 2020 lúc 04:24 AM
...
CREATE TABLE `khachsan` (
  ...
  `nam_ks` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `khachsan` (`id_ks`, `nam_ks`, `id_dd`, `rate_ks`) VALUES
(1, 'Khách sạn 1', 1, 4),
(2, 'Khách sạn 2', 2, 5);
